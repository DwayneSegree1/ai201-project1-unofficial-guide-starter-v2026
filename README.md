...
<!-- Two specific moments. For each: what you asked for, what came back, and
     ...
     Milestone 5. -->
     Getting the requirements setup took forever as i didnt have the correct python version to get the system running. I asked chat gpt questions regarding the requirements and how to troubleshoot them for example: 
