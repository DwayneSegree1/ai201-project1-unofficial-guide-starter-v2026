...
class _OnnxEmbedder:
    ...
    def __init__(self):
        ...
        # Left to itself, Chroma uses every ONNX provider it can find. On this
        # Mac that includes CoreML, which fails to run the model and takes
        # indexing down with it. Pinning to CPU costs a little speed on 91
